...
- They know how to define Node environment variables
////
...
////
If configuration options are defined in multiple places, which takes precedence?
////
...
////
It doesn't look like there are any Elastic-specific config options.
Is that correct?
////
