...
If you need more control over your configuration after getting set up, you can learn more in https://opentelemetry.io/docs/languages/js[OpenTelemetry SDK documentation].
