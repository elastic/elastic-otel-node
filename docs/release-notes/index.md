...
## 1.18.0 [edot-node-1.18.0-release-notes]

### Chores [edot-node-1.18.0-chores]

* Update all `@opentelemetry/*` upstream package dependencies to the latest releases:
    - [`v2.11.0` release](https://github.com/open-telemetry/opentelemetry-js/releases/tag/v2.11.0) from opentelemetry-js
    - [`experimental/v0.222.0` release](https://github.com/open-telemetry/opentelemetry-js/releases/tag/experimental%2Fv0.222.0) from opentelemetry-js
    - [opentelemetry-js-contrib release](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3638#issuecomment-5483990456)

## 1.17.0 [edot-node-1.17.0-release-notes]

### Chores [edot-node-1.17.0-chores]
...
* Update all `@opentelemetry/*` upstream package dependencies to the latest releases:
    ...
    - [opentelemetry-js-contrib release](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3524#issuecomment-4711431551)
...
## 1.12.0 [edot-node-1.12.0-release-notes]

### Chores [edot-node-1.12.0-chores]
...
## 1.11.0 [edot-node-1.11.0-release-notes]

### Chores [edot-node-1.11.0-chores]
...
* Update all `@opentelemetry/*` upstream package dependencies to the latest releases:
    ...
    - [opentelemetry-js-contrib release](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3451#issuecomment-4270731672)
